...
print(fit_weibull, pars = c("alpha", "mu", "beta"))
print(fit_weibull, pars = c("sigma"))

stan_plot(fit_weibull, pars = c("alpha", "mu", "beta"))
stan_trace(fit_weibull, pars = c("alpha", "mu", "beta"))
